...
setup_builtins!(interpreter, {
    ...
    "текст" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 1 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
                format!(
    ...
    "добавить" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() < 2 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
        ...
        match &arguments[0] {
            ...
            Value::Array(_) => Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
    ...
    "получить" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 2 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
        ...
        match &arguments[0] {
            Value::List(list) => {
                let idx: i64 = match arguments[1].clone().try_into() {
                    Ok(i) => i,
                    Err(err) => return Err(RuntimeError::InvalidOperation(ErrorData::new(span, err)))
                };
    ...
    "удалить" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 2 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
    ...
    "изменить" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 3 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
    ...
    "длина" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 1 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
    ...
    "ключи" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 1 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
    ...
    "значения" (arguments, span) -> Result<Value, RuntimeError> {
        if arguments.len() != 1 {
            return Err(RuntimeError::InvalidOperation(ErrorData::new(
                span,
